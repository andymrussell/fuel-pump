...
class Messages
{
	 ...
	 * @return void
	 */
	public static function set($message, $type='I', $wipe = FALSE)
	{
		...
		switch ($type)
		{
			...
			case 'S':	// success messages
			case 'I':	// informational messages
			case 'BW':	// block warning messages
			case 'BE':	// block error messages
			case 'BS':	// block success messages
			case 'BI':	// block informational messages			
			
				break;
			default:
				$type = 'I';	// default type is normal
		}
	...
	public static function get_flash_messages()
	{
		...
		if(isset($messages))
		{
			static::$_messages = array_merge($messages, static::$_messages);
		}
	}
	...
	public static function get_messages()
	{
		...
		$message = implode('',$return_message);
		return $message;
	}
